...
var DataView = function (_props)
{
    let _defaultParams = {
        ...
        advancedSqlFiltersName: "advancedSqlFilters"
    };
    ...
    let _url = _props.url, _guid = _props.guid, _cacheData = _props.cacheData, _dvInputName = _props.dvInputName, _tableDataName = _props.tableDataName, _advancedSqlFiltersName = _props.advancedSqlFiltersName;
            ...
            _raDvs = new RemoteArray(
                {
                    ...
                    {
                        let dvInp = new r.constructor[_dvInputName]();
                        dvInp[_tableDataName] = new r.constructor[_tableDataName]({
                            currentRecord: p.startPage * p.recordsPerPage,
                            "recordsPerPage": p.recordsPerPage
                        });
                        if (p.filterData)
                        {
                            dvInp[_advancedSqlFiltersName] = p.filterData;
                        }
