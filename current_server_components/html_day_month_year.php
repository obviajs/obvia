 ...
 */
class html_day_month_year extends html_element {
		...
		return 
            "<div class='form-group col-lg-{$this->col_span} rowspan{$this->row_span} resizable'
				...
				<div style=\"width: 100% !important; float: left;\">	
					<div style=\"width: 30% !important; float: left; padding-right: 5px;\">
						<!--label for='{$this->form_field_id}_day'>Dita{$this->required}</label-->
						<select class=\"form-control day_month_year\"
							name=\"{$this->form_field_id}_day\" id=\"{$this->form_field_id}_day\">
							<option value=\"\">-Dita-</option>
							$dayHtml
						</select> 
					</div >
					<div style=\"width: 40% !important; float: left; padding-right: 5px;\">
						<!--label for='{$this->form_field_id}_month'>Muaji{$this->required}</label-->
						<select class=\"form-control day_month_year\" name=\"{$this->form_field_id}_month\" id=\"{$this->form_field_id}_month\">
					...
					<div style=\"width: 30% !important; float: left; padding-right: 5px;\">
						...
						<select class=\"form-control day_month_year\" name=\"{$this->form_field_id}_year\" id=\"{$this->form_field_id}_year\">
    ...
    public function script_load() {
		return
			$this->formVariables() .
           "$('.day_month_year').change(function () {  
