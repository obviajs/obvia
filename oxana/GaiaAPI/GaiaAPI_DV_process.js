...
var GaiaAPI_DV_process = function () {
    ...
    var dataview_pid_4 = function (apiClient) {
        apiClient = apiClient || new ApiClient();
        /*{typeMap}*/

        /**
         *This method returns the list of dataviews
         * @param {dvInput} dvInput The request body for post /dataview_pid_4 
         * @returns {Promise} 
         */
        ...
        this.basePath = _server + "/dataview_pid_4";
    };

    this.dataview_pid_4Client = new dataview_pid_4();
