var GaiaAPI_processes = function (_props) {
    ...
    */
    ...
    this.arrayProcess = function () {
        let r = ArrayEx.apply(this, arguments);
        r.memberType = ["process"];
        return r;
    };
    this.arrayProcess.prototype = Object.create(ArrayEx.prototype);
    ...
    */
    this.recordsAffected = function (_props) {
        _props = _props || {};
    ...
    */
    ...
    this.arrayPrsForm = function () {
        let r = ArrayEx.apply(this, arguments);
        r.memberType = ["prs_form"];
        return r;
    };
    this.arrayPrsForm.prototype = Object.create(ArrayEx.prototype);
    ...
    */
    ...
    this.arrayProcessRole = function () {
        let r = ArrayEx.apply(this, arguments);
        r.memberType = ["process_role"];
        return r;
    };
    this.arrayProcessRole.prototype = Object.create(ArrayEx.prototype);
    ...
    */
    this.status_case_count = function (_props) {
        _props = _props || {};
    ...
    this.arrayStatusCaseCount = function () {
        let r = ArrayEx.apply(this, arguments);
        r.memberType = ["status_case_count"];
        return r;
    };
    this.arrayStatusCaseCount.prototype = Object.create(ArrayEx.prototype);

    /**
	* @property {String}  team_members               - Team names

    */
    this.user_team_members = function (_props) {
        _props = _props || {};
