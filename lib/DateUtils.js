...
DateUtils.format = function (value, inputFormat, outputFormat)
{
    ...
    // return m.isValid() ? m.format(outputFormat) : "-"; // original return
    return m.year() > 1899 ? m.format(outputFormat) : "-"; //temporary workaround when the date has no value(0000-00-00)
};
