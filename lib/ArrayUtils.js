...
public static  function h_getMatching(collection, key, matchingValue, childrenproperty='children')
{
    for(var i=0;i<collection.length;i++)
    {
        ...
        {
            var tmp = h_getMatching(node[childrenproperty], key, matchingValue, childrenproperty);
