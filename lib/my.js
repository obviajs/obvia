...
$.fn.attributes = function (all = false)
{
	let skip = [];
	if (!all)
	{
...
function downloadFromUrl(filename, url, post, headers={})
{
	return new Promise((resolve, reject) =>
	{
		var postEnc, method;
...
export
{
	isSymbol, get, eraseCookieFromAllPaths, downloadFromUrl, downloadFromUrlLink, download, getFontAwesomeIconFromMIME, getCaretPosition, setCaretPosition, extractText
};