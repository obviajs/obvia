...
function simpleAjax(url, data, fnsuccess, fnfailure, method = null) {
	...
	method = method == null ? ((data && !ObjectUtils.isEmpty(data)) ? "POST" : "GET") : method;
	$.ajax({
		type: method,
		url: url,
		data: data,
...
export {
	isSymbol, get, eraseCookieFromAllPaths, downloadFromUrl, download, getFontAwesomeIconFromMIME, getCaretPosition
};