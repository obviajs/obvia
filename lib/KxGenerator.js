    ...
    createComponent: function (cmp) {
        ...
        return function (props, debug = false) {
           ...
           // var component = Object.assign({}, $.extend(true, {}, cmp));
            ...
            for (var p in props) {
                if (typeof(component[p])==="object" && !(component[p] instanceof Array)){
                    component[p] = Object.assign(component[p], $.extend(true, {}, props[p]))
                }else
                    component[p] = props[p];
            }
            ...
            component.guid = KxGenerator.guid();
            ...
            if (component.hasOwnProperty('spacing')) {
                if (component.spacing.hasOwnProperty('offset'))
                    component.$el.addClass('offset-lg-' + component.spacing.offset);
