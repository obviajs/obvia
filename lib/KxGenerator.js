...
var KxGenerator = {
    ...
    createComponent: function (cmp) {
        ...
        return function (props, debug = false) {
            ...
            // console.log(component.$el[0])
            ready("#" + component.id + '-wrapper', function (element) {
                ...
                if (typeof component.registerEvents == 'function') 
                {
                    ...
                    handlers.forEach(function(handler, i)
                    {
                        for(var innerEventIn in handler.events)
                        {
                            ...
                            {
                                handler.registerTo.on(innerEventIn, function()
                                {
                                    var event = arguments[0];
                                    event.stopImmediatePropagation();
                                    event.stopPropagation();
            
                                    handler.events[innerEventIn].apply(component, arguments);
                                    ...
                                    if (component.parentType == 'repeater')
                                        ...
                                        component.$component.trigger(innerEventIn, component);
                                });
                            }
                        }
                    });
            ...
            component.on = function (eventType, fnc) {
                    ...
                    } else
                    {
                        if (typeof fnc == 'function') 
                        {
                            component.$component.on(eventType, function()
                            {
                                var event = arguments[0];
                                event.stopImmediatePropagation();
                                event.stopPropagation();
                                ...
                                if (component.parentType == 'repeater')
                                {
                                    args = args.concat([component, component.parent,
                                        new RepeaterEventArgs(
                                            component.parent.rowItems[component.repeaterIndex],
                                            component.parent.dataProvider.items[component.repeaterIndex],
                                            component.repeaterIndex
