    ...
    if(toBind.length>0)
    {
        if(site != null && site != undefined && site_chain != undefined && Array.isArray(site_chain) && site_chain.length>0) 
		{
            ...
            {   
                ...
                {
                    if((defaultContextProperty!=null) && Object.prototype.hasOwnProperty.call(context, defaultContextProperty) && Object.prototype.hasOwnProperty.call(context[defaultContextProperty], toBind[i][0]))
                    {
