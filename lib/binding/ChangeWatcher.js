        ...
        if (chain.length > 0) {
            ...
            if (isNaN(prop)) {
                ...
                if (hostWatcher.handlers[uuid] != null && hostWatcher.handlers[uuid][prop] != null) {
                    ...
                    if (_hostPropertyDescriptors == null)
                        _hostPropertyDescriptors = Object.assign({}, Object.getOwnPropertyDescriptors(Object.getPrototypeOf(host)), Object.getOwnPropertyDescriptors(host));
