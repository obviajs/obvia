...
ChangeWatcher.prototype.reset = function (host, chain) {
...
ChangeWatcher.prototype.unwatch = function (host, chain) {
    if(!(host["guid"]==undefined || host["guid"]==null || this.handlers[host["guid"]]==undefined)){
            ...
            if (chain.length > 0)
            {
                ...
                if(this.handlers[uuid][prop]!=undefined && Array.isArray(this.handlers[uuid][prop]["handlers"])){
                    ...
                    if(chain.length==0){//stop condition
    ...
    if (chain.length > 0)
    {
        ...
        }else
        {
           ...
           // host=Object.assign(host, {_prop: {value: host[prop]}});
            ...
            originalGetter = function(){console.log("getter for: ", "_"+proxyProp," value:",this, this["_"+proxyProp]); return this["_"+proxyProp]};
        }
        if((!!objFromDesc[prop]['set']))
        {
