 /**
	 ...
	 * 
     */
var RemoteCursorArray = function(p)
{
	var _defaultParams = {
		threshold:2,
		autoRetry:false,
	...
	var _getData_Action = props.getData_Action;
	...
	*/
	...
	this._fnUpdateSuccess = function(data, isPreload)
	{
	...
	this._fnUpdateFailed = function(textStatus, errorThrown, isPreload)
	{
		...
		if(!_busy){
			...
			// }else{
				...
				simpleAjax(_getData_Action, _postExt, 
					function (result) { _self._fnUpdateSuccess.call(thisContext, result, isPreload);}, 
					function (textStatus, errorThrown) { _self._fnUpdateFailed.call(thisContext, textStatus, errorThrown, isPreload);});		
			// }
		}else
		{
			//TODO: hidh eventin
