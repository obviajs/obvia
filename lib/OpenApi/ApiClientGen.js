...
var ApiClientGen = function (_props) {
    ...
    import { HttpClient } from "${_importsBaseUrl}/flowerui/lib/OpenApi/HttpClient.js";
    import { OAMethod } from "${_importsBaseUrl}/flowerui/lib/OpenApi/OAMethod.js";
    ...
    //_props = ObjectUtils.extend(false, false, _defaultParams, _props);
    let _server = _props.server, _apiClient = _props.apiClient ? _props.apiClient : new HttpClient(), _self = this;
