		...
		if (scanItem.deviceId) 
		{
			if(this.Scanners) 
			{
				...
				if(match.objects.length > 0) 
				{
					...
					scanItem.WIA_HORIZONTAL_SCAN_SIZE_PIXELS = scanItem.WIA_HORIZONTAL_SCAN_SIZE_PIXELS > match.WIA_HORIZONTAL_SCAN_SIZE_PIXELS ? match.WIA_HORIZONTAL_SCAN_SIZE_PIXELS : scanItem.WIA_HORIZONTAL_SCAN_SIZE_PIXELS;
					scanItem.WIA_VERTICAL_SCAN_SIZE_PIXELS = scanItem.WIA_VERTICAL_SCAN_SIZE_PIXELS > match.WIA_VERTICAL_SCAN_SIZE_PIXELS ? match.WIA_VERTICAL_SCAN_SIZE_PIXELS : scanItem.WIA_VERTICAL_SCAN_SIZE_PIXELS;
