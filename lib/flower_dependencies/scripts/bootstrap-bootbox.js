...
!function (a, b) {
    ...
    p.alert = function () {
        ...
        var a, d, e, f, h, i, k;
        if (f = b(n.form), d = {className: "bootbox-prompt", buttons: l("cancel", "confirm"), value: "", inputType: "text"}, a = m(j(d, arguments, ["title", "callback"]),
                ["cancel", "confirm"]), i = a.show === c ? !0 : a.show, a.message = f, a.buttons.cancel.callback = a.onEscape = function () {
    ...
    var q = {br: {OK: "Po", CANCEL: "Jo", CONFIRM: "Sim"},
        cs: {OK: "PO", CANCEL: "Zrušit", CONFIRM: "Potvrdit"},
