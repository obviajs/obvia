...
(function ($) {
    ...
    $.fn.uploadFile = function (options, multiple) {
        ...
        var formGroup = "ajax-file-upload-" + '_' + Math.random().toString(36).substr(2, 9);
        ...
        function setDragDropHandlers(obj, s, ddObj) {
            ...
            ddObj.on('drop', function (e) {
                ...
                $(this).css('border', '1px solid rgba(204, 204, 204, 0.6)');
                e.preventDefault();
                obj.errorLog.html("");
            ...
            $(document).on('dragover', function (e) {
                e.stopPropagation();
                e.preventDefault();
                ddObj.css('border', '1px solid rgba(204, 204, 204, 0.6)');
            });
            $(document).on('drop', function (e) {
                e.stopPropagation();
                e.preventDefault();
                ddObj.css('border', '1px solid rgba(204, 204, 204)');
            });
        ...
        function serializeAndUploadFiles(s, obj, files) {
            for (var i = 0; i < files.length; i++) {
                ...
                pd.filename.html(fileNameStr.truncate(26,'middle'));
            ...
            var options = {
                ...
                beforeSubmit: function (formData, $form, options) {
                    ...
                    pd.cancel.click(function () {
                        pd.statusbar.remove();
                        var queueCounter = $('.ajax-file-upload-statusbar').length;
                        s.onDeselect(queueCounter);
                    });
