...
var ApiClientGen = function (_props) {
    ...
    let base = BrowserManager.getInstance().base;
    let apiTemplate = `
    import { Poolable } from "${base}/flowerui/lib/Poolable.js";
    import { ApiClient } from "${base}/flowerui/lib/ApiClientGen/ApiClient.js";
    import { OAMethod } from "${base}/flowerui/lib/ApiClientGen/OAMethod.js";
    import { ArrayEx } from "${base}/flowerui/lib//ArrayEx.js";
    import { ObjectUtils } from "${base}/flowerui/lib/ObjectUtils.js";
    import { StringUtils } from "${base}/flowerui/lib/StringUtils.js";
