...
var ApiClientGen = function (_props) {
    ...
    let apiTemplate = `    import { Poolable } from "${_importsBaseUrl}/flowerui/lib/Poolable.js";
    import { ApiClient } from "${_importsBaseUrl}/flowerui/lib/ApiClientGen/ApiClient.js";
    import { OAMethod } from "${_importsBaseUrl}/flowerui/lib/ApiClientGen/OAMethod.js";
    import { ArrayEx } from "${_importsBaseUrl}/flowerui/lib//ArrayEx.js";
    import { ObjectUtils } from "${_importsBaseUrl}/flowerui/lib/ObjectUtils.js";
    import { StringUtils } from "${_importsBaseUrl}/flowerui/lib/StringUtils.js";
        ...
        if (typeInfo.type == "object") {
            if (typeNames.indexOf(propName) < 0) {
                ...
                if (typeInfo.additionalProperties) {
                    if (ObjectUtils.isObject(typeInfo.additionalProperties) && !Object.isEmpty(typeInfo.additionalProperties)) {
            ...
            } else if (ObjectUtils.isObject(typeInfo.items) && Object.isEmpty(typeInfo.items)) {
            ...
            let arrTypeName = propName = StringUtils.convertToCamelCase("array-" + allowedTypes.join("-"));
