...
import { PropertyChangeEvent } from "/flowerui/lib/binding/PropertyChangeEvent.js";
import { RemoteDataEvent } from "/flowerui/lib/rca/RemoteDataEvent.js";
var ArrayEx = function () {
    ...
    let r = new Proxy(this, {
        ...
        get: function (target, property, receiver) {
            ...
            //     return i;
            // } else
            if (!target.hasOwnProperty(property) && _remoteArray && StringUtils.isString(property) && !isNaN(property)) {
                _remoteArray.gotoRecord(parseInt(property));
            } else if (_remoteArray && StringUtils.isString(property) && !isNaN(property)) {
                _remoteArray.gotoRecord(parseInt(property));
